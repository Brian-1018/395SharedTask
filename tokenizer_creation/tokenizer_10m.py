...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default="../data/babycosmofine_10M.jsonl", help='Specify the input filename')
    parser.add_argument('--validation_path', type=str, default="../data/babycosmofine_10M.jsonl", help='Specify the validation filename')
    parser.add_argument('--vocab_path', type=str, default="../tokenizers/tokenizer_10M.json", help='Specify the output filename')
